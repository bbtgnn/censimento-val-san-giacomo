  ...
  fields: [
    ...
    { name: 'elementi_urbanistici', type: 'select', options: Object.values(elementi_urbanistici) },
    {
      ...
      fields: [
        ...
        { name: 'edifici_civili', type: 'number', required: true },
        { name: 'edifici_rurali', type: 'number', required: true },
        { name: 'edifici_multifunzione', type: 'number', required: true },
        { name: 'edifici_rovina', type: 'number', required: true },
      ],
    },
    {
      name: 'hide',
